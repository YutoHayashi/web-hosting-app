                        ...
                        <div className={ `grid lg:grid-cols-2` }>
                            ...
                            <div className={ `shadow py-10 px-5 md:px-10` }>
                                ...
                                <label html-for='password-input' className={ `mb-5 block` }>
                                    ...
                                    <input id='password-input' type='password' name='password' className={ `form-input rounded w-full text-gray-400` } minLength={ 8 } maxLength={ 32 } autoComplete='new-password' placeholder={ i18next.t( 'password_placeholder' ) } required></input>
                                </label>
                                <label html-for='repassword-input' className={ `mb-5 block` }>
                                    ...
                                    <br />
                                    <p className={ `block text-gray-500 text-sm` }></p>
                                    <input id='repassword-input' type='password' name='password' className={ `form-input rounded w-full text-gray-400` } minLength={ 8 } maxLength={ 32 } placeholder={ i18next.t( 're-password_placeholder' ) } required></input>
                                </label>
                                <div className={ `grid lg:grid-cols-2` }>
                                    <div></div>
